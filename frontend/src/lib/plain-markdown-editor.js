    ...
    return (
      <div className="menu toolbar-menu">
        { this.props.saving ? (
          ...
          <ButtonGroup>
            <IconButton id={'saveButton'} text={'Save'} icon={"fa fa-save"} onMouseDown={this.props.onSave} disabled={!isSaveActive} isActive={isSaveActive} />
          </ButtonGroup>
        )}
        <MoreMenu switchToRichTextEditor={this.props.switchToRichTextEditor} />
        <Alert stack={{limit: 3}} />
      </div>
    );
  }
