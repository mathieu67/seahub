...
class RichMarkdownEditor extends React.Component {
  ...
  */
  ...
  onAddTable(event) {
    ...
    if (editTable.utils.isSelectionInTable(value)) {
      ...
      // reset table align, and return chang
      ...
      <div className="menu toolbar-menu">
        ...
        { showBlockButton === true &&
          <ButtonGroup>
            ...
            <IconButton text={'Check List Item'} id={'checkListItemButton'} icon={"fa fa-check-square"} onMouseDown={this.onAddCheckItem} />
          </ButtonGroup>
        }
        ...
        <ButtonGroup>
          {
            showLinkButton === true &&
            <IconButton text={'Insert Link'} id={'linkButton'} icon={'fa fa-link'} isActive={isLinkActive} onMouseDown={this.onToggleLink}/>
          }
          { showCodeButton === true &&
            <IconButton text={'Code'} id={'codeButton'} icon={"fa fa-code"} onMouseDown={this.onToggleCode} isActive={isCodeActive}/>
          }
          { showAddTableButton === true && this.renderAddTableButton()}
          { showImageButton === true &&
            <IconButton text={'Insert Image'} id={'imageButton'} icon={"fa fa-image"} onMouseDown={this.onAddImage} isActive={isImageActive}/>
          }
        </ButtonGroup>
        ...
        { this.props.saving ? (
          ...
          <ButtonGroup>
            <IconButton text={'Save'} id={'saveButton'} icon={"fa fa-save"} onMouseDown={this.onSave} disabled={!isSaveActive} isActive={isSaveActive}/>
          </ButtonGroup>
        )}
        <MoreMenu id={'moreButton'} text={'More'}  switchToPlainTextEditor={this.props.switchToPlainTextEditor} />
        <AddImageDialog
          showAddImageDialog={this.state.showAddImageDialog}
  ...
  renderAddTableButton = () => {
    ...
    return(
      <IconButton text={'Insert Table'} id={'tableButton'} icon={'fa fa-table'} onMouseDown={onAddTable}/>
    )
  };
  ...
  renderMarkButton = (type, icon) => {
    ...
    return (
      ...
      <IconButton text={toolTipText} id={type + 'Button'} onMouseDown={onMouseDown} isActive={isActive} icon={icon}></IconButton>
    )
  }
  ...
  */
  renderBlockButton = (type, icon) => {
    ...
    return (
      // eslint-disable-next-line react/jsx-no-bind
      <IconButton text={toolTipText} id={type + "Button"} onMouseDown={onMouseDown} isActive={isActive} icon={icon}/>
    )
  }
