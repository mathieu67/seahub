...
class TreeNodeView extends React.Component {
  ...
  renderCollapse = () => {
    ...
    if (node.hasChildren()) {
      ...
      return (
        <i
          className={isExpanded ? 'fa fa-caret-down' : 'fa fa-caret-right'}
  ...
  render() {
    ...
    return (
      <div  type={type}
        ...
        style={styles}
      >
        <div onMouseLeave={this.onMouseLeave} onMouseEnter={this.onMouseEnter} type={type} className="tree-node-inner text-nowrap">
          {this.renderCollapse()}
